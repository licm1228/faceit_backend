...
-- 面试会话表
DROP TABLE IF EXISTS "public"."t_interview_session";
CREATE TABLE "public"."t_interview_session" (
    "id" varchar(20) NOT NULL,
    ...
    "create_time" timestamp DEFAULT CURRENT_TIMESTAMP,
    "update_time" timestamp DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "t_interview_session_position_id_fkey" FOREIGN KEY ("position_id") REFERENCES "public"."t_position"("id"),
    PRIMARY KEY ("id")
);

-- 面试问题回答表
DROP TABLE IF EXISTS "public"."t_interview_answer";
CREATE TABLE "public"."t_interview_answer" (
    "id" varchar(20) NOT NULL,
    ...
    "create_time" timestamp DEFAULT CURRENT_TIMESTAMP,
    "update_time" timestamp DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "t_interview_answer_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "public"."t_interview_session"("id"),
    CONSTRAINT "t_interview_answer_question_id_fkey" FOREIGN KEY ("question_id") REFERENCES "public"."t_question"("id"),
    PRIMARY KEY ("id")
);

-- 面试评估指标表
DROP TABLE IF EXISTS "public"."t_evaluation_metric";
CREATE TABLE "public"."t_evaluation_metric" (
    "id" varchar(20) NOT NULL,
...
-- 面试回答评估详情表
DROP TABLE IF EXISTS "public"."t_answer_evaluation";
CREATE TABLE "public"."t_answer_evaluation" (
    "id" varchar(20) NOT NULL,
    ...
    "create_time" timestamp DEFAULT CURRENT_TIMESTAMP,
    "update_time" timestamp DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "t_answer_evaluation_answer_id_fkey" FOREIGN KEY ("answer_id") REFERENCES "public"."t_interview_answer"("id"),
    CONSTRAINT "t_answer_evaluation_metric_id_fkey" FOREIGN KEY ("metric_id") REFERENCES "public"."t_evaluation_metric"("id"),
    PRIMARY KEY ("id")
);

-- 插入默认评估指标
INSERT INTO "public"."t_evaluation_metric" ("id", "metric_name", "description", "weight") VALUES
('2039217000000000001', '技术准确性', '回答的技术内容是否正确', 0.3),
('2039217000000000002', '知识深度', '回答的深度和广度', 0.25),
('2039217000000000003', '表达清晰度', '回答的逻辑和表达是否清晰', 0.2),
('2039217000000000004', '问题理解', '对问题的理解是否准确', 0.15),
('2039217000000000005', '代码能力', '代码示例的质量和正确性', 0.1);
