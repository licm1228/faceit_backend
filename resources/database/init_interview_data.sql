...
-- 插入测试工程师题目（使用UPSERT）
INSERT INTO t_question (id, position_id, question_type, difficulty, question_text, reference_answer, keywords, create_time, update_time, deleted) VALUES
('12', '6', '技术题', 3, '请解释软件测试的类型', '软件测试的主要类型包括：\n1. 单元测试：测试单个代码单元\n2. 集成测试：测试模块间的交互\n3. 系统测试：测试整个系统\n4. 验收测试：验证系统是否满足需求\n5. 回归测试：确保修改不会引入新问题\n6. 性能测试：测试系统性能\n7. 安全测试：测试系统安全性', '{\"软件测试\", \"测试类型\", \"质量保证\"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
('13', '6', '技术题', 4, '请解释自动化测试的优缺点', '自动化测试的优点：\n1. 提高测试效率\n2. 减少人为错误\n3. 可重复执行\n4. 覆盖更多测试场景\n\n缺点：\n1. 初始投入大\n2. 维护成本高\n3. 无法测试所有场景\n4. 对测试人员技术要求高', '{\"自动化测试\", \"测试效率\", \"测试维护\"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)
ON CONFLICT (id) DO NOTHING;
